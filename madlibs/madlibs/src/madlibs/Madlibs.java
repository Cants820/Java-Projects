...
public class Madlibs {
    ...
    public void putTogetherTheStory() {
        ...
        if(num == 0) {
            story = "Jesse and her best friend " + getName() + " went to Disney World today!"
                ...
                + getAdjective1() + " feast for dinner. The next day I ran " + getAdverb() + " to meet Mickey Mouse"
                + "in his " + getNoun2() + " and then that night I gazed at the  " + getRandomNumber() + " " + getAdjective2()
                + " fireworks shooting from the " + getNoun3() + ".";
        } else {
            story = "Amanda and her friends " + getName() + " went to the zoo last summer."
                    + "They saw a huge " + getNoun1() + " and tiny little " + getNoun2() + " . That night" +
                    " they decided to climb " + getAdverb() + " into the " + getNoun3() + " to get a closer look." +
                    "The zoo was " + getAdjective1() + "at night, but they didn't care..." + "until " + getRandomNumber() + " " 
    ...
    public void enterAdjective2() {
        System.out.println("Give me anothter adjective!");
        setAdjective2(scanner.nextLine());
    }

    public void enterAdverb() {
        System.out.println("Give me an adverb good people");
